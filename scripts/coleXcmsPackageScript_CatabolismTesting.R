...
resultsPath = "X:/Labs/Chapple/0-Cole Wunderlich/Results/0-Stem Feeding/Test3"
...
for(phenoTag in runList)
{
  ...
  {
    pairedGroups_matrix = read.csv(file.path(resultsPath,paste(phenoTag,"nLabel",nLabel,"Clusters_MatrixForm.csv",sep="_")),check.names=F,stringsAsFactors=F)
